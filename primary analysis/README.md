...
- For single-patient inference with the frozen radiomics signature, use `code/predict_popf_risk.py` with `configs/exported_model.pkl` (see `docs/runbook.md` section 6). Post-hoc calibration is generated by `code/models/comparative_risk_stratification_v2.py`.
